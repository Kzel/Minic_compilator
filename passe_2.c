...
void gen_code_ope(node_t root){
    ...
    if(fin == false && root->opr[0]->nature == NODE_INTVAL){
            ...
            int32_t reg_0=get_current_reg();
            create_inst_ori(reg_0, get_r0(), root->opr[0]->value);

            if(root->opr[1]->nature == NODE_INTVAL){

                allocate_reg();
                int32_t reg_1=get_current_reg();
                create_inst_ori(reg_1, get_r0(), root->opr[1]->value);

                switch(root->nature){

                    case NODE_PLUS:
                        create_inst_addu(reg_0, reg_0, reg_1);
                        break;

                    case NODE_DIV:
                        create_inst_div(reg_0, reg_1);
                        create_inst_teq(reg_1, 0);
                        create_inst_mflo(reg_0);
                        break;

                    case NODE_MINUS:
                        create_inst_subu(reg_0, reg_0, reg_1);
                        break;

                    case NODE_MUL:
                        create_inst_mult(reg_0, reg_1);
                        break;

                    case NODE_MOD:
                        create_inst_div(reg_0, reg_1);
                        create_inst_teq(reg_1, 0);
                        create_inst_mfhi(reg_0);
                        break;

                    case NODE_BXOR:
                        create_inst_xor(reg_0, reg_0, reg_1);
                        break;    
                    
                    case NODE_BAND:
                        create_inst_and(reg_0, reg_0, reg_1);
                        break;  

                    case NODE_BOR:
                        create_inst_or(reg_0, reg_0, reg_1);
                        break;    

                    case NODE_SRL:
                        create_inst_srlv(reg_0, reg_0, reg_1);
                        break;

                    case NODE_SRA:
                        create_inst_srav(reg_0, reg_0, reg_1);
                        break;   

                    case NODE_SLL:
                        create_inst_sllv(reg_0, reg_0, reg_1);
                        break;       

                }

                release_reg();
                push_temporary(reg_0);
